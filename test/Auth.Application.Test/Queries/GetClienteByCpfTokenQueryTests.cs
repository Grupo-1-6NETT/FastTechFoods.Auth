...
public class GetClienteByCpfTokenQueryTests
{
    ...
    public GetClienteByCpfTokenQueryTests()
    {
        _repositoryMock = new Mock<IClienteRepository>();
        _tokenServiceMock = new Mock<ITokenService>();
        _encrypterMock = new Mock<IEncrypter>();
        _sut = new GetClienteTokenQueryHandler(
    ...
    {
        var query = new GetClienteByCpfTokenQuery("cliente@mail.com", "password");
    ...
    {
        var query = new GetClienteByCpfTokenQuery("", "");
        var expectedToken = string.Empty;

        _repositoryMock.Setup(x => x.GetByCpfAsync(It.IsAny<string>(), It.IsAny<string>()))
